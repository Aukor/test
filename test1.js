	...
	sendRequest: function (list) {
		list.each(function(index, element) {
			...
			success: function(result) {
			    document.AdditionalCompanyInformation.successRequest($(element), $(contentElement), $(result));
			}
		    });
		});
	},
...
document.AdditionalCompanyInformation = AdditionalCompanyInformation;
