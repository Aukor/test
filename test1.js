	...
	sendRequest: function (list) {
		list.each(function(index, element) {
			...
			success: function(result) {
			    AdditionalCompanyInformation.successRequest($(element), $(contentElement), $(result));
			}
		    });
		});
	},
